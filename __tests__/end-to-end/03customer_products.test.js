...
describe(requirement(16), () => {
  test.only("O avaliador testará a existência de um botão de carrinho com um valor total válido e que seja capaz de nos direcionar a tela de checkout", async () => {
    const itemList = action.customer.getRandomProducts();
