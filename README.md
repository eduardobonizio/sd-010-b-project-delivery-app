...
- `git clone git@github.com:tryber/sd-010-b-project-delivery-app.git`.
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-010-b-project-delivery-app/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-010-b-project-delivery-app/pulls) e confira que o seu _Pull Request_ está criado
...
- `sd-010-b-project-delivery-app/back-end/package.json`
- `sd-010-b-project-delivery-app/front-end/package.json`
